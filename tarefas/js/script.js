...
function renderizarTarefas(){
    // 4) Limpa a listagem de itens antes de renderizar novamente a tela
    lista.innerHTML = '';

    // Para cada tarefa da lista de tarefas imprime pra mim essa tarefa.
...
//Executando a função para renderizar
renderizarTarefas();
...
function salvarDadosNoStorage(){
    ...
    // Todo o navegador web possui esta capacidade
