...
btn.onclick = function(){
    ...
    // Limpar o conteúdo da div, pois quando carregamos a página o conteúdo anterior precisa ser limpo.
    div.innerHTML = '';
    ...
    // Enviar a requisição, utilizamos o null por causa do método get, que não envia dados, somente pega eles.
    // Não estamos enviando nenhum dado, somente pedindo ele.
    ajax.send(null);
